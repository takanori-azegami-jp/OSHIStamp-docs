# OSHIStamp（おしスタンプ）：YouTube 動画タイムスタンプ作成支援・AI 要約ツール
...
さらに、AI 要約や動画単位の保存メモリストからワンクリックで該当の動画にジャンプできるため、作成済みのタイムスタンプにもスムーズにアクセスできます。
...
- [プライバシーポリシー](https://takanori-azegami-jp.github.io/OSHIStamp-docs/Chrome-policy.html)
